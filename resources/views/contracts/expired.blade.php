...
<head>
    ...
    <title>Contract Link Expired</title>
            ...
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <div class="text-center">
                    ...
                    <ul class="text-sm text-gray-600 space-y-2">
                        <li>• Contact your HR department for a new invitation link</li>
                        <li>• Check your email for any updated contract information</li>
